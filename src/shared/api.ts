...
export const api = createApi({
    ...
    tagTypes: ['Items', 'Partners', 'Depots', 'Positions', 'Stock', 'RemitosEntrada', 'Orders', 'RemitosSalida', 'Dashboard', 'BoxTypes', 'Tasks', 'User', 'PurchaseOrders', 'Maintenance', 'Machine', 'Production', 'MachineChange'],
