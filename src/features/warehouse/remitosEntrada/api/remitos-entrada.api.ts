...
export const { useGetRemitosEntradaQuery, useGetRemitoEntradaQuery, useLazyGetRemitoEntradaQuery, useCreateRemitoEntradaMutation, useDeleteRemitoEntradaMutation } = remitosEntradaApi;
