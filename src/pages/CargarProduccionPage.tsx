...
import { addRecord, selectTempRecords } from '../features/production/model/productionSlice';
import type { ProductionRecord } from '../features/production/model/productionSlice';
...
export default function CargarProduccionPage() {
    ...
    const tempRecords = useSelector(selectTempRecords);
                    ...
                    <Card style={{ padding: '0', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column' }}>
                        <Box sx={{ p: 2, borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                Sesión Actual ({tempRecords.length})
                            </Typography>
